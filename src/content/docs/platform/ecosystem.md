...
| Repository | Owns |
| --- | --- |
| `GapwiseHQ/gapwise` | web/PWA behavior, canonical student-state semantics, deterministic timetable/gap/routing logic, public API v1, OpenAPI, and both official SDK implementations |
| `GapwiseHQ/android` | native Android UX, device integration, secure mobile persistence, and Android distribution |
...
- GitHub: `https://github.com/GapwiseHQ`
